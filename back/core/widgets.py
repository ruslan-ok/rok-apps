...
from core.categories import get_categories_list
...
class AvatarInput(widgets.FileInput):
    ...
    def get_context(self, name, value, attrs):
        context = super().get_context(name, value, attrs)
        context['avatar_url'] = value.url if value and type(value) == ImageFieldFile else '/static/account/img/Default-avatar.jpg'
        return context
