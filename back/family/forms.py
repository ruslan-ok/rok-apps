...
class EditFamTreeForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['name', 'sour', 'sour_vers', 'sour_name', 'sour_corp', 'sour_data', 'sour_data_date', 'sour_data_copr', 
                  'dest', 'trans_date', 'trans_time', 'file', 'copr', 'gedc_vers', 'gedc_form', 'char_set', 'char_vers', 'lang', 'note', 
        ...
        widgets = {
            ...
            'trans_date': forms.TextInput(attrs={'class': 'form-control mb-2', 'readonly': True}), 
            'trans_time': forms.TextInput(attrs={'class': 'form-control mb-2', 'readonly': True}), 
            ...
            'char_set': forms.TextInput(attrs={'class': 'form-control mb-2', 'readonly': True}), 
