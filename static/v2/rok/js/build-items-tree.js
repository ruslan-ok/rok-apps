...
function initGroup(grp) {
  ...
  if (grp.is_open)
    div.children[0].children[0].setAttribute('src', '/static/v2/rok/icon/direct-down.png');
  else
    div.children[0].children[0].setAttribute('src', '/static/v2/rok/icon/direct-right.png');
}
