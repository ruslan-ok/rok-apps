...
function initLi(node, visible) {
  ...
  if (!node.is_leaf)
    if (node.is_open)
      li.children[1].children[0].setAttribute('src', '/static/v2/rok/icon/direct-down.png');
    else
      li.children[1].children[0].setAttribute('src', '/static/v2/rok/icon/direct-left.png');
