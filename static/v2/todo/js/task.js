...
function toggleCompleted() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      if (x.dataset.value.toLowerCase() == "true") {
        x.children[0].setAttribute('src', '/static/v2/todo/icon/complete.png');
        x.parentNode.children[1].classList.add("completed");
        x.parentNode.children[2].classList.add("completed");
      } else {
        x.children[0].setAttribute('src', '/static/v2/todo/icon/uncomplete.png');
...
function toggleImportant() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      if (x.dataset.value.toLowerCase() == "true")
        x.children[0].setAttribute('src', '/static/v2/todo/icon/important-on.png');
      else
        x.children[0].setAttribute('src', '/static/v2/todo/icon/important-off.png');
    }
  };
...
function createStep(step_id, step_name) {
      ...
      img1.setAttribute('src', '/static/v2/todo/icon/step-uncomplete.png');
      ...
      img2.setAttribute('src', '/static/v2/rok/icon/delete.png');
...
function stepComplete(id) {
  ...
  if (x.classList.contains("completed")) {
    y.childNodes[1].childNodes[1].setAttribute('src', '/static/v2/todo/icon/step-complete.png');
  } else {
    y.childNodes[1].childNodes[1].setAttribute('src', '/static/v2/todo/icon/step-uncomplete.png');
  }
  stepChange(id);
}
