...
urlpatterns = [
    ...
    path('department/create/',            views.depart_add,     name='depart_add'),
    ...
    path('post/create/',                  views.post_add,       name='post_add'),
    ...
    path('pay_title/create/',             views.pay_title_add,  name='pay_title_add'),
    ...
    path('period/create/',                views.period_add,     name='period_add'),
    ...
    path('employee/create/',              views.empl_add,       name='empl_add'),
    ...
    path('employee/<int:empl>/period/<int:y>/<int:m>/',    views.empl_per_form,  name='empl_per_form'),
                                                              
    path('employee/<int:empl>/period/<int:y>/<int:m>/accruals/',                  views.accrual_list,   name='accrual_list'),
    path('employee/<int:empl>/period/<int:y>/<int:m>/accrual/create/',            views.accrual_add,    name='accrual_add'),
    path('employee/<int:empl>/period/<int:y>/<int:m>/accrual/<int:pk>/',          views.accrual_form,   name='accrual_form'),
    path('employee/<int:empl>/period/<int:y>/<int:m>/accrual/<int:pk>/delete/',   views.accrual_del,    name='accrual_del'),
                                                               
    path('employee/<int:empl>/period/<int:y>/<int:m>/payouts/',                   views.payout_list,    name='payout_list'),
    path('employee/<int:empl>/period/<int:y>/<int:m>/payout/create/',             views.payout_add,     name='payout_add'),
    path('employee/<int:empl>/period/<int:y>/<int:m>/payout/<int:pk>/',           views.payout_form,    name='payout_form'),
    path('employee/<int:empl>/period/<int:y>/<int:m>/payout/<int:pk>/delete/',    views.payout_del,     name='payout_del'),
]
