...
from v2_account.forms import (RegisterForm, PasswordResetForm, SetPasswordForm, PasswordChangeForm, ProfileForm, )
...
class LoginView(SuccessURLAllowedHostsMixin, FormView):
    ...
    template_name = 'v2_account/login.html'
...
class LogoutView(SuccessURLAllowedHostsMixin, TemplateView):
    ...
    next_page = None
    redirect_field_name = REDIRECT_FIELD_NAME
    template_name = 'v2_account/index.html'
    extra_context = None
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if f.is_valid():
            ...
            message = '\n' + gettext('Please visit the following link to verify your account') + ' \n\n' + \
                      '{}://{}/v2_account/activate/?key={}'.format(request.scheme, request.get_host(), activation_key)            
    ...
    return render(request, 'v2_account/register.html', context)
...
def activate_account(request):
    ...
    return render(request, 'v2_account/activated.html', context)
...
class PasswordResetView(PasswordContextMixin, FormView):
    email_template_name = 'v2_account/password_reset_email.html'
    extra_email_context = None
    form_class = PasswordResetForm
    from_email = None
    html_email_template_name = None
    subject_template_name = 'v2_account/password_reset_subject.txt'
    success_url = reverse_lazy('v2_account:password_reset_done')
    template_name = 'v2_account/password_reset_form.html'
...
class PasswordResetDoneView(PasswordContextMixin, TemplateView):
    template_name = 'v2_account/password_reset_done.html'
...
class PasswordResetConfirmView(PasswordContextMixin, FormView):
    ...
    success_url = reverse_lazy('v2_account:password_reset_complete')
    template_name = 'v2_account/password_reset_confirm.html'
...
class PasswordResetCompleteView(PasswordContextMixin, TemplateView):
    template_name = 'v2_account/password_reset_complete.html'
    title = _('Password reset complete')

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['login_url'] = resolve_url('v2_account:login') #resolve_url(settings.LOGIN_URL)
        return context
...
class PasswordChangeView(PasswordContextMixin, FormView):
    ...
    template_name = 'v2_account/password_change_form.html'
...
class PasswordChangeDoneView(PasswordContextMixin, TemplateView):
    template_name = 'v2_account/password_change_done.html'
...
def service(request):
    ...
    return render(request, 'v2_account/service.html', context)
...
def profile(request):
    ...
    return render(request, 'v2_account/profile.html', context)
