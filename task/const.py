...
NUM_ROLE_APACHE = 39
NUM_ROLE_BACKUP_NUC_SHORT = 40
NUM_ROLE_BACKUP_NUC_FULL = 41
NUM_ROLE_BACKUP_VIVO_SHORT = 42
NUM_ROLE_BACKUP_VIVO_FULL = 43
...
ROLE_BACKUP_NUC_SHORT = 'nuc_short'
ROLE_BACKUP_NUC_FULL = 'nuc_full'
ROLE_BACKUP_VIVO_SHORT = 'vivo_short'
ROLE_BACKUP_VIVO_FULL = 'vivo_full'
ROLE_APACHE      = 'apache'
...
ALL_ROLES = (
    ...
    ROLE_ACCOUNT,  
    ROLE_SEARCH_RESULTS,
    ROLE_BACKUP_NUC_SHORT,
    ROLE_BACKUP_NUC_FULL,
    ROLE_BACKUP_VIVO_SHORT,
    ROLE_BACKUP_VIVO_FULL,
    ROLE_APACHE,
    )
...
ROLES_IDS = {
    ...
    APP_BACKUP: { ROLE_BACKUP_NUC_SHORT: NUM_ROLE_BACKUP_NUC_SHORT, ROLE_BACKUP_NUC_FULL: NUM_ROLE_BACKUP_NUC_FULL,
                ROLE_BACKUP_VIVO_SHORT: NUM_ROLE_BACKUP_VIVO_SHORT, ROLE_BACKUP_VIVO_FULL: NUM_ROLE_BACKUP_VIVO_FULL },
...
ROLE_ICON = {
    ...
    ROLE_BACKUP_NUC_SHORT: 'save',
    ROLE_BACKUP_NUC_FULL: 'save-fill',
    ROLE_BACKUP_VIVO_SHORT: 'save',
    ROLE_BACKUP_VIVO_FULL: 'save-fill',
}
