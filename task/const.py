...
NUM_ROLE_MANAGER = 43
NUM_ROLE_BACKUP_CUSTOM = 44
NUM_ROLE_BACKUP_V3_SHORT = 45
...
ROLE_BACKUP_V3_SHORT = 'v3_short'
ROLE_BACKUP_FULL = 'full'
ROLE_BACKUP_CHECK = 'check'
ROLE_BACKUP_CUSTOM = 'backup'
ROLE_APACHE      = 'apache'
...
ROLES_IDS = {
    ...
    APP_BACKUP: { 
        ...
        ROLE_BACKUP_V3_SHORT: NUM_ROLE_BACKUP_V3_SHORT, 
        ROLE_BACKUP_FULL: NUM_ROLE_BACKUP_FULL, 
        ROLE_BACKUP_CHECK: NUM_ROLE_BACKUP_CHECK, 
        ROLE_BACKUP_CUSTOM: NUM_ROLE_BACKUP_CUSTOM },
