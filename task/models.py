...
class Task(models.Model):
  ...
  due_date = models.DateTimeField(u'Время исполнения', null = True)
  active   = models.PositiveSmallIntegerField(u'Активна', default=0)
  attrib   = models.IntegerField(u'Атрибуты задачи', default=0)
  def __str__(self):
