...
class LangListView(LoginRequiredMixin, PermissionRequiredMixin, ListView, Context):
    model = Lang
...
class LangDetailView(LoginRequiredMixin, PermissionRequiredMixin, UpdateView, Context):
    model = Lang
    form_class = EditForm
